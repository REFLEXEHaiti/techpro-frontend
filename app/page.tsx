...
const STATS = [
  { valeur: '3 200+', label: 'Professionnels formés' },
  { valeur: '85',     label: 'Formations disponibles' },
  { valeur: '16',     label: 'Domaines couverts' },
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'center' }}>
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 20, paddingTop: 28, borderTop: '1px solid rgba(255,255,255,0.1)' }}>
              {STATS.map(s => (
                <div key={s.label}>
                  <div style={{ fontSize: 'clamp(16px,2vw,24px)', fontWeight: 900, color: secondaire }}>{s.valeur}</div>
