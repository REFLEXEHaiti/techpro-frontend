...
const FORMATIONS_DEMO = [
  { id: 'demo-1', titre: 'Développement Web Full Stack', description: 'HTML, CSS, JavaScript, React, Node.js — devenez développeur full stack en Haïti.', niveau: 'DEBUTANT', categorie: 'Développement Web', publie: true, gratuit: true, _count: { lecons: 10, inscriptions: 342 }, imageUrl: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=600&q=80' },
  { id: 'demo-2', titre: 'Cybersécurité & Ethical Hacking', description: 'Sécurité des réseaux, tests de pénétration, cryptographie et gestion des vulnérabilités.', niveau: 'INTERMEDIAIRE', categorie: 'Cybersécurité', publie: true, gratuit: false, _count: { lecons: 14, inscriptions: 218 }, imageUrl: 'https://images.unsplash.com/photo-1471864190281-a93a3070b6de?w=600&q=80' },
  { id: 'demo-3', titre: 'Cloud Computing et réanimation', description: 'Protocoles d\'urgence, réanimation cardio-pulmonaire, gestion des polytraumatisés en milieu précaire.', niveau: 'AVANCE', categorie: 'Cloud Computing', publie: true, gratuit: false, _count: { lecons: 18, inscriptions: 187 }, imageUrl: 'https://images.unsplash.com/photo-1516549655169-df83a0774514?w=600&q=80' },
  { id: 'demo-4', titre: 'Data Science & Python', description: 'Pandas, NumPy, Machine Learning et visualisation de données appliqués à des projets réels.', niveau: 'INTERMEDIAIRE', categorie: 'Data Science', publie: true, gratuit: false, _count: { lecons: 16, inscriptions: 156 }, imageUrl: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&q=80' },
  { id: 'demo-5', titre: 'Intelligence Artificielle & Deep Learning', description: 'TensorFlow, PyTorch, réseaux de neurones et NLP — construisez des modèles IA fonctionnels.', niveau: 'AVANCE', categorie: 'Intelligence Artificielle', publie: true, gratuit: false, _count: { lecons: 20, inscriptions: 243 }, imageUrl: 'https://images.unsplash.com/photo-1677442135703-1787eea5ce01?w=600&q=80' },
  { id: 'demo-6', titre: 'Santé communautaire haïtienne', description: 'Prévention, éducation sanitaire, vaccination et santé publique dans les communautés haïtiennes.', niveau: 'DEBUTANT', categorie: 'Santé publique', publie: true, gratuit: true, _count: { lecons: 8, inscriptions: 412 }, imageUrl: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=600&q=80' },
];
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: 'clamp(24px,4vw,48px) clamp(20px,5vw,48px)' }}>
        ...
        <div style={{ marginTop: 48, background: '#0D1B2A', borderRadius: 12, padding: '28px 32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 20 }}>
          <div>
            ...
            <p style={{ fontFamily: "'Helvetica Neue',Arial,sans-serif", fontSize: 13, color: 'rgba(255,255,255,0.65)', margin: 0, maxWidth: 480 }}>Documentation, e-books et ressources techniques pour approfondir chaque formation.</p>
          </div>
